...
module.exports=[
    ...
    check("password").notEmpty().withMessage("Tienes que escribir una contraseña con más de 5 caracteres"),
    check("price").notEmpty().isLength({ min: 0, max: 20}).isNumeric().withMessage("Tienes que escribir una cifra válida"),
    ...
    /*check("name").notEmpty().isAlpha().withMessage("Tiene que completar el nombre"),
